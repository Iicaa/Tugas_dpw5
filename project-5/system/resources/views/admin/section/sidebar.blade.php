    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ url('dashboard')}}" class="nav-link {{ checkRouteActive('admin/produk') }}">
          ...
          <li class="nav-item">
            <a href="{{ url('produk')}}" class="nav-link {{ checkRouteActive('admin/Kategori') }}">
          ...
          <li class="nav-item">
            <a href="{{ url('categories')}}" class="nav-link {{ checkRouteActive('admin/user') }}">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Categories
              </p>
